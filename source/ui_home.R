home_page <- 
  div(id="home",
      ...
      br(),
      actionBttn("start_btn",label="Get Started!", size="sm", color="default", style = "simple"),
      br(),br(),br(),
      p(""),
      br(),br(),
      fluidRow(id = "app_intro",
        column(6,
                      div(style = "background: #170344; padding: 15px; text-align: justify; height: calc(60px + (515px - 22vw)); border-radius: 5px;",
      ...
      column(12,
             br(),
             br(),
             div(style = "background: #170344; padding: 15px; text-align: justify; border-radius: 5px;",
