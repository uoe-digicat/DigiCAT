...
if(params$CF_approach == "psm" | params$CF_approach == "iptw"){
  params$common_support_plot + ggtitle("Common Support Graph")
}

## Observation table
kable(params$observation_table, caption = "Observation table", align = "l")

## Love Plot
params$love_plot + ggtitle("Love Plot: Covariate Balance")

## Balance table
kable(params$balance_table, caption = "Balance table", align = "l")
