...
home_ui <- function(id) {
  ...
  tabPanel(title = "",
           ...
           div(style = "display: flex;",
               div(style = "width: 21%; text-align: justify;",
                   class = "text_blocks",
           ...
           fluidRow(
             column(12,
                  ...
                  more accurate estimation of the causal effect of receiving the treatment. For more info, see our ", 
                               a("tutorial", href = "https://uoe-digicat.github.io/#overview-of-tutorials"), ".")),
                        div(class = "text_blocks",
                            ...
                            h5("DigiCAT stands for ‘Digital counterfactual analysis tool’. With DigiCAT, you can leverage propensity 
                               ...
                               to utilize these methods effectively. Please visit our ", a("tutorial", href = "https://uoe-digicat.github.io/#overview-of-tutorials"),
             ...
             column(12,
                    ...
                    div(class = "text_blocks",
                        ...
                        h3("Our Approach:"),
                        h5("DigiCAT was developed with the help of a lived experience expert group (LINK NEEDED). It took a user-centred approach (LINK NEEDED) to design and we 
                           continue to welcome feedback from users at:", a(href='mailto:uoe_digicat-group@uoe.onmicrosoft.com', "uoe_digicat-group@uoe.onmicrosoft.com"), "It was designed with FAIR principles 
                           in mind and you can find all code for the tool ", a(href='https://github.com/uoe-digicat/DigiCAT', "here."))))
           ))
